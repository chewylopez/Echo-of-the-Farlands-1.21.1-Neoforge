...
public class ModStructurePlacementType<SP extends StructurePlacement> {
    ...
    //  public static final DeferredHolder<StructurePlacement, WallStructurePlacement> WALL_PLACEMENT_1 = STRUCTURE_POSITIONS.register("first_wall", () -> new WallStructurePlacement());
